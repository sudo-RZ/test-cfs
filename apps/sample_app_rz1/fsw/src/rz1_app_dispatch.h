...
#ifndef RZ1_APP_DISPATCH_H
#define RZ1_APP_DISPATCH_H
...
** llama desde RZ1_APP_TaskPipe() en rz1_app_dispatch.c, ej:
**   void RZ1_APP_HandleRz2Data(const RZ2_APP_DataTlm_t *Msg);
** (implementado en rz1_app_cmds.c, ver ese archivo)
*/

#endif /* RZ1_APP_DISPATCH_H */
