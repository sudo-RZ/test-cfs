...
#include "rz1_app_eds_dispatcher.h"
#include "rz1_app_eds_dictionary.h"

/*
 * Define a lookup table for SAMPLE app command codes
 */
/* clang-format off */
static const EdsDispatchTable_EdsComponent_RZ1_APP_Application_CFE_SB_Telecommand_t SAMPLE_TC_DISPATCH_TABLE = 
{
    .CMD =
    {
        .NoopCmd_indication          = RZ1_APP_NoopCmd,
        .ResetCountersCmd_indication = RZ1_APP_ResetCountersCmd,
        .ProcessCmd_indication       = RZ1_APP_ProcessCmd,
        .DisplayParamCmd_indication  = RZ1_APP_DisplayParamCmd
    },
    .SEND_HK =
    {
        .indication = RZ1_APP_SendHkCmd
    }
};
/* clang-format on */
...
void RZ1_APP_TaskPipe(const CFE_SB_Buffer_t *SBBufPtr)
{
    ...
    Status = EdsDispatch_EdsComponent_RZ1_APP_Application_Telecommand(SBBufPtr, &SAMPLE_TC_DISPATCH_TABLE);
    ...
    if (Status != CFE_SUCCESS)
    {
        ...
        {
            CFE_EVS_SendEvent(RZ1_APP_MID_ERR_EID, CFE_EVS_EventType_ERROR,
        ...
        {
            CFE_EVS_SendEvent(RZ1_APP_CC_ERR_EID, CFE_EVS_EventType_ERROR,
